...
it('can add the star name and star symbol properly', async() => {
    ...
    let user1 = accounts[1];
    let starId = 6;
    await instance.createStar('Test Start', starId, {from: user1});
...
it('lets 2 users exchange stars', async() => {
    ...
    let starId1 = 7;
    let starId2 = 8;
    await instance.createStar('Test Start1', starId1, {from: user1});
    await instance.createStar('Test Start2', starId2, {from: user2});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    assert.equal(starName,'Test Start1')
});